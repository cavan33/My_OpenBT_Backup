...
library(pryr); object_size(preds_test) # Should be only a few MB (not 100+!)

# rgy = c(-2, 2); fmean.out = NA
fit_test <- openbt(x, y, model="merck_truncated", ndpost=N, nadapt=nadapt, nskip=burn, power=beta,
